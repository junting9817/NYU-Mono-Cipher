...
def decrypt_Levenshtein(ciphertext, numPlaintexts): # Compare ciphertext frequencies to each plaintext file
    ...
    SPACE_CHAR = ' '
    plaintext = ''
    for i in range(1,numPlaintexts+1):
        ...
        print("Combined value for plaintext",i,": ",dist_Dvi)
        #print(distance)

        if lowest_sum == -1 or dist_Dvi < lowest_sum:
            lowest_sum = dist_Dvi
            lowest_index = i
